...
const Inicio = () => {
    ...
    console.log(numero);
    return (
        <div className='h-[calc(100vh_-_191px)] flex-1 flex flex-col md:flex-row items-stretch justify-between px-[50px] gap-8 mt-auto'>
            <div className='flex flex-col justify-center'>
                ...
                <div className='flex items-center rounded-full border-[3px] border-orange-600 justify-between w-[600px] h-[75px] px-4 py-3'>
                    ...
                    <button className='bg-orange-600 px-6 py-2 font-extrabold text-[20px] text-white rounded-full align-baseline flex justify-center hover:bg-orange-700 transform-fill duration-300 cursor-pointer'>Buscar</button>
                </div>
            </div>
